...
void input() {			// Procedure untuk input
	...
	for (int i = 0; i < n; i++) {	// Looping dengan i dimulai dari 0 hinga n-1
...
int main() {
	input();		// Memanggil read() dari class BubblesSort
	bubblesSortArray();	// Memanggil bubbleSortArray() dari class BubbleSort
